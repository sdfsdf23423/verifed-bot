...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#0a0a12;color:#ccc;min-height:100vh;overflow:hidden}
canvas{position:fixed;top:0;left:0;width:100%;height:100%;z-index:0}
.wrap{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:380px;z-index:1}
...
.field input{width:100%;padding:10px 14px;border:1px solid rgba(255,255,255,.12);border-radius:6px;background:rgba(34,34,34,.7);color:#ddd;font-size:14px;outline:none;font-family:inherit;transition:all .12s}
.field input:focus{border-color:rgba(255,255,255,.25);background:rgba(40,40,40,.85)}
.field input::placeholder{color:#555}
.btn{width:100%;padding:11px 20px;border:1px solid rgba(255,255,255,.12);border-radius:6px;background:rgba(34,34,34,.7);color:#aaa;font-size:13px;font-weight:500;cursor:pointer;font-family:inherit;margin-top:10px;transition:all .12s;position:relative;overflow:hidden}
...
.code-display{background:rgba(255,255,255,.04);border:1px solid #222;border-radius:6px;padding:16px;text-align:center;margin-top:14px;display:none;backdrop-filter:blur(10px)}
.code-val{font-size:28px;font-weight:600;letter-spacing:8px;color:#a78bfa;font-family:'SF Mono','Fira Code',monospace}
...
.msg{padding:10px;border-radius:6px;text-align:center;font-size:13px;margin-top:10px;display:none;backdrop-filter:blur(10px)}
...
footer{color:#222;font-size:11px;margin-top:32px;text-align:center}
</style>
</head>
<body>
<canvas id="c"></canvas>
...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#0a0a12;color:#ccc;min-height:100vh;overflow:hidden}
canvas{position:fixed;top:0;left:0;width:100%;height:100%;z-index:0}
.wrap{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:460px;z-index:1}
.topbar{display:flex;justify-content:space-between;align-items:center;margin-bottom:32px}
.topbar h2{font-size:16px;font-weight:600;color:#eee}
.topbar .logout{color:#444;font-size:12px;text-decoration:none}
.topbar .logout:hover{color:#a55}
.user-block{background:rgba(255,255,255,.04);border:1px solid #1e1e2a;border-radius:8px;padding:24px;margin-bottom:14px;backdrop-filter:blur(10px)}
...
.stat{background:rgba(255,255,255,.04);border:1px solid #1e1e2a;border-radius:8px;padding:16px;backdrop-filter:blur(10px)}
...
.list{background:rgba(255,255,255,.04);border:1px solid #1e1e2a;border-radius:8px;padding:20px;backdrop-filter:blur(10px)}
.list h4{font-size:11px;color:#555;text-transform:uppercase;letter-spacing:1px;margin-bottom:12px}
.list li{list-style:none;padding:8px 0;border-bottom:1px solid #1a1a24;font-size:13px;color:#888}
